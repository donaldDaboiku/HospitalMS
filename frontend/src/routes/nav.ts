...
export const navigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Today's Appointments", to: '/appointments/today', enabled: false },
      { label: 'Waiting List', to: '/appointments/waiting', enabled: false },
    ],
  },
  {
    label: 'Clinical',
    ...
    enabled: false,
    children: [
      { label: 'Encounters', to: '/clinical/encounters', enabled: false },
